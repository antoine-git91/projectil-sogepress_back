 ...
 */
final class Version20220105175813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE support_magazine ADD magazine_id INT , ADD nom VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE support_magazine DROP magazine_id, DROP nom');
    }
}
